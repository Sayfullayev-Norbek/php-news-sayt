                                ...
                                <?php if(!empty($getAllLinks)): ?>
                                    <?php foreach ($getAllLinks as $getAllLink): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="submit" class="btn btn-primary"><a href="?controller=new_update&id=<?=$getAllLink["id"]?>"><i class="fas fa-pen" style="color: white"></i></a></button>
                                                ...
                                                <button type="submit" class="btn btn-info"><a href="?controller=new_read&id=<?=$getAllLink['id']?>"><i class="fas fa-eye" style="color: white"></i></a></button>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
